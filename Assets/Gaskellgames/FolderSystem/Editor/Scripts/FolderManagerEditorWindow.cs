...
namespace Gaskellgames.FolderSystem.EditorOnly
{
    ...
    public class FolderManagerEditorWindow : GgEditorWindow
    {
        ...
        private void OnPageGUI_DefaultIcons()
        {
            ...
            bool selected = GUILayout.Toggle(FolderSystemSettings_SO.Instance.defaultFolderIcons, new GUIContent("", iconTexture, "Use default folder icon?"), EditorStyles.toolbarButton, GUILayout.Width(25));
