...
public partial class BaseItemSection : ICsvImportableConfig, ICsvExportableConfig, ICsvRemarkProvider
{
    ...
    public IReadOnlyList<string> GetCsvRemarks() => CsvBinding_BaseItemDefinition.Remarks;
    ...
    {
        var header = CsvBinding_BaseItemDefinition.Header;
        var remarks = CsvBinding_BaseItemDefinition.Remarks;
